...
var config = Global.config['redis'];
 ...
 * @private
 */
var _instances:{[key:string]:RedisMgr} = {};
...
class RedisMgr {
    ...
    public static getInstance(redisConfigName:string):RedisMgr {
        var redisConfig = config[redisConfigName];
        var _key = redisConfig.host + '_' + redisConfig.port;
